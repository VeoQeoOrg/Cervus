...
_Static_assert(offsetof(task_t, entry)      == 120, "task_t: entry offset changed — update TASK_ENTRY_OFFSET in sched_asm.asm");
_Static_assert(offsetof(task_t, arg)        == 128, "task_t: arg offset changed   — update TASK_ARG_OFFSET in sched_asm.asm");
_Static_assert(offsetof(task_t, stack_base) == 136, "task_t: stack_base offset changed");
_Static_assert(offsetof(task_t, user_rsp)   == 144, "task_t: user_rsp offset changed — update TASK_USER_RSP_OFFSET in sched_asm.asm");
